 ...
 * Generated for Laravel 4.2.11 on 2016-01-09.
 *
...
namespace {
    ...
    class Markdown extends \Phphub\Markdown\Markdown{
    ...
    class Purifier extends \Mews\Purifier\Facades\Purifier{
         ...
         *
         * @param \Mews\Purifier\HTMLPurifier_Config  configuration object
         * @return \Mews\Purifier\HTMLPurifier_Config 
         * @static 
         */
    ...
    class Asset extends \Modbase\AssetManager\Facade\Asset{
        ...
        public static function styles($bundle){
            return \Modbase\AssetManager\Manager::styles($bundle);
        }
        ...
        public static function scripts($bundle){
            return \Modbase\AssetManager\Manager::scripts($bundle);
        }
